...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/proxyroles/joinrole.h"
...
void qqsfpm::JoinRole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<JoinRole *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::JoinRole::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__JoinRole.data,
    qt_meta_data_qqsfpm__JoinRole,
    qt_static_metacall,
    nullptr,
    nullptr
} };
