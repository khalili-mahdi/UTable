...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/filters/indexfilter.h"
...
void qqsfpm::IndexFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IndexFilter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::IndexFilter::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__IndexFilter.data,
    qt_meta_data_qqsfpm__IndexFilter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
