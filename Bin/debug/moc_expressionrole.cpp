...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/proxyroles/expressionrole.h"
...
void qqsfpm::ExpressionRole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ExpressionRole *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::ExpressionRole::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__ExpressionRole.data,
    qt_meta_data_qqsfpm__ExpressionRole,
    qt_static_metacall,
    nullptr,
    nullptr
} };
