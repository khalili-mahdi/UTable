...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/qqmlsortfilterproxymodel.h"
...
void qqsfpm::QQmlSortFilterProxyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQmlSortFilterProxyModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::QQmlSortFilterProxyModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__QQmlSortFilterProxyModel.data,
    qt_meta_data_qqsfpm__QQmlSortFilterProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
