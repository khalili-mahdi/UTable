...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/proxyroles/regexprole.h"
...
void qqsfpm::RegExpRole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RegExpRole *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::RegExpRole::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__RegExpRole.data,
    qt_meta_data_qqsfpm__RegExpRole,
    qt_static_metacall,
    nullptr,
    nullptr
} };
