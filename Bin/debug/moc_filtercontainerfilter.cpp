...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/filters/filtercontainerfilter.h"
...
void qqsfpm::FilterContainerFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FilterContainerFilter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::FilterContainerFilter::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__FilterContainerFilter.data,
    qt_meta_data_qqsfpm__FilterContainerFilter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
