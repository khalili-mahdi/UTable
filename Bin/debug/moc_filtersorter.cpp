...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/sorters/filtersorter.h"
...
void qqsfpm::FilterSorter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<FilterSorter *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::FilterSorter::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__FilterSorter.data,
    qt_meta_data_qqsfpm__FilterSorter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
