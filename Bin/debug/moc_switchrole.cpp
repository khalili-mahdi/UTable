...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/proxyroles/switchrole.h"
...
void qqsfpm::SwitchRoleAttached::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SwitchRoleAttached *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::SwitchRoleAttached::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__SwitchRoleAttached.data,
    qt_meta_data_qqsfpm__SwitchRoleAttached,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SwitchRole *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::SwitchRole::staticMetaObject = { {
    &SingleRole::staticMetaObject,
    qt_meta_stringdata_qqsfpm__SwitchRole.data,
    qt_meta_data_qqsfpm__SwitchRole,
    qt_static_metacall,
    nullptr,
    nullptr
} };
