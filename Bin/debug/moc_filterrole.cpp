...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/proxyroles/filterrole.h"
...
void qqsfpm::FilterRole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<FilterRole *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::FilterRole::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__FilterRole.data,
    qt_meta_data_qqsfpm__FilterRole,
    qt_static_metacall,
    nullptr,
    nullptr
} };
