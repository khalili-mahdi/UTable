...
#include <memory>
#include "../../UTable/SortFilterProxyModel-master/sorters/rolesorter.h"
...
void qqsfpm::RoleSorter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RoleSorter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qqsfpm::RoleSorter::staticMetaObject = { {
    ...
    qt_meta_stringdata_qqsfpm__RoleSorter.data,
    qt_meta_data_qqsfpm__RoleSorter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
